...
// Note: This file was copied from "k8s.io/kubernetes/pkg/util/kernel".
// This is done so we can avoid marking the entire "k8s.io/kubernetes"
// module as a dependency, hence avoiding frequent CVE-related updates.
